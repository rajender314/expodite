...
@Component({
  ...
  styleUrls: ['../../admin-module/organizations/organizations-contacts/organizations-contacts.component.scss'],
...
export class NewClientComponent implements OnInit {
  ...
  createForm(): void {
    this.detailsForm = this.fb.group({
      company_name: [this.data, [Validators.required , this.noWhitespaceValidator , this.noZeroValidator]],
