...
declare var App: any;
@Component({
  selector: 'app-dutydrawback-report',
  templateUrl: './dutydrawback-report.component.html',
  styleUrls: ['./dutydrawback-report.component.scss']
})
export class DutydrawbackReportComponent implements OnInit {
