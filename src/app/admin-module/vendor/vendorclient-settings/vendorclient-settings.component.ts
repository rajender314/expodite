...
@Component({
  selector: 'app-vendorclient-settings',
  templateUrl: './vendorclient-settings.component.html',
  styleUrls: ['./vendorclient-settings.component.scss'],
...
export class VendorclientSettingsComponent implements OnInit, OnChanges {
      ...
      this.organizationsService.addSettings(data)
          .then(response => {
              if (response.result.success) {
                  ...
                  if (App.user_details.id === this.selectedOrganization.id) Object.assign(App.user_details, this.selectedOrganization);
              }
              else {
      ...
      switch (msg) {
          case 'reset':
              data = {
                  ...
                  url: 'forgotPassword',
                  msg: 'Password Reset link will be sent to <b>\'' + this.selectedOrganization[index].email + '\'</b>. Are you sure you want to reset your password?',
                  result: this.selectedOrganization[0]
              };
              break;
      }
      return data;
