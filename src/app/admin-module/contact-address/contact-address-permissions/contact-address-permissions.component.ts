...
@Component({
  selector: 'app-contact-address-permissions',
  templateUrl: './contact-address-permissions.component.html',
  styleUrls: ['./contact-address-permissions.component.scss']
})
export class ContactAddressPermissionsComponent implements OnInit {
  ...
  constructor(private parent: ContactAddressDetailsComponent) { }
