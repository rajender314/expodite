...
export class PrimaryPackageDetailsComponent implements OnInit {
...
// this.addContainers = "Update Package"
  ...
  createForm(): void {
    this.detailsForm = this.fb.group({
      ...
      margin_length: ["", Validators.required],
      margin_width: ["", Validators.required],
      margin_depth: ["", Validators.required],
  ...
  //  console.log(form)
    ...
    param['is_primary_packaging'] = true;
  ...
  //  console.log(data)
    this.detailsForm.setValue({
      ...
      margin_length: (data && data.margin_length) ? data.margin_length : "",
      margin_width: (data && data.margin_width) ? data.margin_width : "",
      margin_depth: (data && data.margin_depth) ? data.margin_depth : "",
